...
* Note: uses volatile, in memory storage, since we haven't studied data persistence yet in the course."# C-ServerSide-integrationTest-node-shopping-list-integration-tests" 
"# node_shopping-list_integration" 
"# shopping_list_integrationTest" 
